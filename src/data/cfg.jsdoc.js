 ...
 * @property {string} [status="Envoyez-moi un message pour obtenir de l'aide !"]
 * @property {"playing"|"watching"|"listening"|"streaming"} [statusType="playing"]
 * @property {string} [statusUrl=""]
 * @property {string} [responseMessage="Merci pour votre message ! Notre équipe de modération vous répondra ici dès que possible."]
 ...
 * @property {string} [accountAgeDeniedMessage="Votre compte Discord n'est pas assez ancien pour contacter le modmail."]
 * @property {number} [requiredTimeOnServer] Required time on server to message Modmail, in minutes
 * @property {string} [timeOnServerDeniedMessage="Vous n'êtes pas membre du serveur depuis suffisamment longtemps pour contacter le modmail."]
 ...
 * @property {object} [categoryAutomation.newThreadFromReason]
